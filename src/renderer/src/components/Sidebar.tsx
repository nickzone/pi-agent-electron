...
export function Sidebar(): React.JSX.Element {
  ...
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-white/10 bg-zinc-950/60">
      <div className="flex items-center justify-between border-b border-white/10 px-3 py-2">
        ...
        <button
          ...
          title="新建项目"
          className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-zinc-300 hover:bg-white/5 hover:text-white"
        >
          ...
          {projects.map((p) => {
            ...
            return (
              <li key={p.id}>
                <div
                  className={cn(
                    'group flex items-center gap-1.5 rounded-md px-2 py-1.5 text-sm text-zinc-200 hover:bg-white/5',
                    expanded && 'bg-white/5',
                  )}
                >
                  <button
